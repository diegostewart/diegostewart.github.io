...
// Toggle between light and dark theme settings (no system mode).
...
// Determine the computed theme, which can be "dark" or "light". The computed theme
// is simply the theme setting (no system preference detection).
